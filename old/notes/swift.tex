...
\chapter{Swift}
\section{基本操作}
\lstinputlisting[style = CodeLstStyleSwift, caption = {基本操作}]{
    resources/code/swift/003-code-basic.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/003-result-basic.txt
}


\section{函数}
\lstinputlisting[style = CodeLstStyleSwift, caption = {函数}]{
    resources/code/swift/006-code-function.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/006-result-function.txt
}


\section{可选类型}
\lstinputlisting[style = CodeLstStyleSwift, caption = {可选类型}]{
    resources/code/swift/004-code-optional.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/004-result-optional.txt
}


\section{控制流}
\lstinputlisting[style = CodeLstStyleSwift, caption = {控制流示例}]{
    resources/code/swift/005-code-control.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/005-result-control.txt
}


\section{枚举}
\lstinputlisting[style = CodeLstStyleSwift, caption = {枚举}]{
    resources/code/swift/001-code-enum.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/001-result-enum.txt
}


\section{集合}
\lstinputlisting[style = CodeLstStyleSwift, caption = {集合类型}]{
    resources/code/swift/002-code-container.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/002-result-container.txt
}
...
\lstinputlisting[style = CodeLstStyleSwift, caption = {闭包}]{
    resources/code/swift/016-code-closure.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/016-result-closure.txt
}
...
\section{类和结构体}
\lstinputlisting[style = CodeLstStyleSwift, caption = {类和结构体}]{
    resources/code/swift/008-code-class-struct.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/008-result-class-struct.txt
}
\subsection{结构体和类对比}
...
\lstinputlisting[style = CodeLstStyleSwift, caption = {属性基本使用}]{
    resources/code/swift/017-code-attribute.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/017-result-attribute.txt
}
...
\lstinputlisting[style = CodeLstStyleSwift, caption = {extension}]{
    resources/code/swift/011-code-extension.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/011-result-extension.txt
}
...
\end{ArtCaution}
\lstinputlisting[style = CodeLstStyleSwift, caption = {协议}]{
    resources/code/swift/012-code-protocol.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/012-result-protocol.txt
}

\section{错误处理}
\lstinputlisting[style = CodeLstStyleSwift, caption = {协议}]{
    resources/code/swift/015-code-error.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/015-result-error.txt
}
...
\lstinputlisting[style = CodeLstStyleSwift, caption = {可选链}]{
    resources/code/swift/014-code-option-chain.swift
}
\lstinputlisting[style = CodeLstStylePlainText, title = {运行结果}]{
    resources/code/swift/014-result-option-chain.txt
}
