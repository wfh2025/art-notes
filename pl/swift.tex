...
\lstinputlisting[style = lstCodeStyleSwift, caption = {基本操作}]{
  res/pl/swift/code/003-code-basic.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/003-result-basic.txt
}

\section{函数}
\lstinputlisting[style = lstCodeStyleSwift, caption = {函数}]{
  res/pl/swift/code/006-code-function.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/006-result-function.txt
}

\section{可选类型}
\lstinputlisting[style = lstCodeStyleSwift, caption = {可选类型}]{
  res/pl/swift/code/004-code-optional.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/004-result-optional.txt
}

\section{控制流}
\lstinputlisting[style = lstCodeStyleSwift, caption = {控制流示例}]{
  res/pl/swift/code/005-code-control.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/005-result-control.txt
}

\section{枚举}
\lstinputlisting[style = lstCodeStyleSwift, caption = {枚举}]{
  res/pl/swift/code/001-code-enum.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/001-result-enum.txt
}

\section{集合}
\lstinputlisting[style = lstCodeStyleSwift, caption = {集合类型}]{
  res/pl/swift/code/002-code-container.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/002-result-container.txt
}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {闭包}]{
  res/pl/swift/code/016-code-closure.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/016-result-closure.txt
}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {类和结构体}]{
  res/pl/swift/code/008-code-class-struct.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/008-result-class-struct.txt
}
\subsection{结构体和类对比}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {属性基本使用}]{
  res/pl/swift/code/017-code-attribute.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/017-result-attribute.txt
}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {extension}]{
  res/pl/swift/code/011-code-extension.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/011-result-extension.txt
}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {协议}]{
  res/pl/swift/code/012-code-protocol.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/012-result-protocol.txt
}

\section{错误处理}
\lstinputlisting[style = lstCodeStyleSwift, caption = {协议}]{
  res/pl/swift/code/015-code-error.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/015-result-error.txt
}
...
\lstinputlisting[style = lstCodeStyleSwift, caption = {可选链}]{
  res/pl/swift/code/014-code-option-chain.swift
}
\lstinputlisting[style = lstCodeStylePlainText, title = {运行结果}]{
  res/pl/swift/code/014-result-option-chain.txt
}
