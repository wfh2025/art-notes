...
\begin{enumerate}[labelindent=0pt, itemsep=0pt, parsep=0pt,
...
caption={引用不能重定位}]{res/pl/cpp/code/010-ref-not-redirect.cpp}

\section{初始化}
\subsection{初始化变量}
\lstinputlisting[style=lstCodeStyleCpp,
caption={初始化变量}]{res/pl/cpp/code/011-init.cpp}

\section{继承}
\subsection{简单继承}
\lstinputlisting[style=lstCodeStyleCpp,
caption={简单继承}]{res/pl/cpp/code/012-inherit.cpp}

\subsection{public继承}
\lstinputlisting[style=lstCodeStyleCpp,
caption={public继承}]{res/pl/cpp/code/013-inherit-public.cpp}
